  ...
  <View style={styles.container}>
    ...
    <View style={styles.boxSaldo}>
      ...
      <TouchableOpacity style={{backgroundColor: ColorGlobal.AzulNormal, height: 60, marginTop: 5, marginLeft: 15, marginRight: 15, marginBottom: 10, borderRadius: 10, alignItems: "center", justifyContent: "center"}} onPress={() => navigator.navigate("PlanejamentoMensal")}>
        <Text style={{color: ColorGlobal.FundoCards, fontSize: 20}}>Crie suas metas de ganhos aqui! </Text>
      </TouchableOpacity>
      ...
      <TouchableOpacity  style={{backgroundColor: ColorGlobal.AzulEscuro, height: 40, width: 80, borderRadius: 15, position: "absolute", bottom: 10, left: 20, justifyContent: "center", alignItems:"center"}} onPress={() => navigation.goBack()}>
