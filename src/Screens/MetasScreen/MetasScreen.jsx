...
export default function MetasScreen() {
  ...
  <View style={styles.container}>
    ...
    <View style={styles.boxSaldo}>
      ...
      <TouchableOpacity  style={{backgroundColor: ColorGlobal.AzulEscuro, height: 40, width: 80, borderRadius: 15, position: "absolute", bottom: 10, left: 20, justifyContent: "center", alignItems:"center"}} onPress={() => navigator.goBack()}>
