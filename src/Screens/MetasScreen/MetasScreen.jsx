...
export default function MetasScreen() {
  ...
  <View style={styles.container}>
    ...
    <View style={styles.boxSaldo}>
      ...
      <TouchableOpacity style={{backgroundColor: ColorGlobal.AzulNormal, height: 40, marginTop: 5, marginLeft: 15, marginRight: 15, marginBottom: 10, borderRadius: 10, alignItems: "center", justifyContent: "center"}} onPress={() => navigator.navigate("PlanejamentoMensal")}>
